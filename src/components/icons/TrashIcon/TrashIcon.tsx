...
export const TrashIcon = (props: BoxProps) => (
  <Box {...props}>
    <Icon
      ...
      display="block"
    >
      <path d="M2 4.60022H18.2" stroke="#ccc" strokeLinejoin="round" />
      <path
      ...
      />
      <path d="M8.30005 9.10022V14.5002" stroke="#ccc" strokeLinejoin="round" />
      <path d="M11.9001 9.10022V14.5002" stroke="#ccc" strokeLinejoin="round" />
    </Icon>
  </Box>
);
